...
async function reproduce() {
    ...
    console.log("2. Fetching systems to test on...");
    let systemId = 0;
    try {
    ...
    console.log(`3. Attempting to bulk enable USB for system ${systemId}...`);
    try {
        const res = await fetch(`${baseUrl}/api/systems/bulk/usb`, {
            method: "PUT",
            headers: {
